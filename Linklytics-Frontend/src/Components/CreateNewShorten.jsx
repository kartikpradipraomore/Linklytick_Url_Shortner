...
const CreateNewShorten = ({ setOpen, refetch }) => {
  ...
  const createShortUrlHandler = async (data) => {
    ...
    try {
      ...
      const shortenUrl = `${
        import.meta.env.VITE_BACKEND_URL + "/" + `${res.shortUrl}`
      }`;
  ...
  return (
    <div className=" flex justify-center items-center bg-white rounded-md">
      ...
      >
        ...
        <button
          className="bg-red-600 font-semibold text-white w-32  bg-gradient-to-r from-purple-600 via-pink-500 to-red-500  py-2  transition-colors  rounded-md my-3"
          type="text"
        >
