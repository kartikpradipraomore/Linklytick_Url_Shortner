...
import { useStoreContext } from "../Components/ContextApi";
...
const ShortenItem = ({ originalUrl, shortUrl, clickCount, createdDate }) => {
  ...
  // const firstCount = totalClicks[0]?.count;
  ...
  const fetchMyShortUrl = async () => {
    ...
    try {
      const { data } = await api.get(
        `/api/urls/analytics/${selectedUrl}?startDate=2025-05-31T00:00:00&endDate=2025-05-31T23:59:59`,
        {
          headers: {
    ...
    >
      ...
      >
        ...
        <div className="flex  flex-1  sm:justify-end items-center gap-4">
          ...
          >
            <div className="flex cursor-pointer gap-1 items-center bg-blue-800 py-2  font-semibold shadow-md shadow-slate-500 px-6 rounded-md text-white ">
